...
export const userApi = {
  ...
  updateRoles: (id, roleNames) => api.put(`/admin/users/${id}/roles`, { roleNames }),
  setEnabled: (id, enabled) => api.patch(`/admin/users/${id}/enabled?enabled=${enabled}`),
...
export const roleApi = {
  ...
  updatePermissions: (id, permissionNames) => api.put(`/admin/roles/${id}/permissions`, permissionNames),
};
